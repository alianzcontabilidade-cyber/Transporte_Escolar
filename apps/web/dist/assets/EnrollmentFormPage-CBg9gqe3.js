import{b as P,r as d,e as v,j as e,F,_ as D,D as O,h as U,U as q,a as u}from"./index-BrMsB7td.js";import{g as G,b as Y}from"./reportUtils-DO_tWvvv.js";import{R as H,E as Q,h as V}from"./reportTemplate-p5nKJRUH.js";import"./globe-BWSs1et0.js";function ee(){var j,S,$;const{user:f}=P(),n=(f==null?void 0:f.municipalityId)||0,[p,C]=d.useState(""),[r,b]=d.useState(null),[E,z]=d.useState(null),[i,k]=d.useState(null),[N,A]=d.useState([]);d.useEffect(()=>{n&&G(n,u).then(z).catch(()=>{})},[n]);const{data:w}=v(()=>u.students.list({municipalityId:n}),[n]),{data:R}=v(()=>u.schools.list({municipalityId:n}),[n]),{data:T}=v(()=>u.municipalities.getById({id:n}),[n]),y=(w||[]).filter(t=>{var a;return!p||((a=t.name)==null?void 0:a.toLowerCase().includes(p.toLowerCase()))||(t.enrollment||"").includes(p)}),B=R||[],o=T,m=t=>B.find(a=>a.id===t),_=t=>{const a=t||{},c=m(a.schoolId),l=a.shift==="afternoon"?"Tarde":a.shift==="evening"?"Noite":a.shift?"Manhã":"________",x=h=>h?new Date(h).toLocaleDateString("pt-BR"):"____/____/________",s=(h,M,J)=>`<div class="field" style=""><div class="field-label">${h}</div><div class="field-value">${M||"_".repeat(40)}</div></div>`,L=`<!DOCTYPE html><html><head><meta charset="utf-8"><title>Ficha de Matrícula - NetEscol</title>
    <style>
    ...
    </body></html>`,g=window.open("","_blank");g&&(g.document.write(L),g.document.close(),setTimeout(()=>g.print(),500))},I=()=>{const t=y.map(l=>{var x;return{nome:l.name||"--",matricula:l.enrollment||"--",serie:l.grade||"--",turma:l.classRoom||"--",turno:l.shift==="afternoon"?"Tarde":l.shift==="evening"?"Noite":"Manha",escola:((x=m(l.schoolId))==null?void 0:x.name)||"--"}}),c=Y("LISTA DE ALUNOS MATRICULADOS",t,["Nome","Matricula","Serie","Turma","Turno","Escola"],E,{orientation:"landscape",signatories:N});if(!c){alert("Nenhum dado para exportar");return}b({html:c,filename:"ficha_matricula"})};return e.jsxs("div",{className:"p-6",children:[e.jsxs("div",{className:"flex items-center justify-between mb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("div",{className:"w-10 h-10 rounded-xl bg-indigo-100 flex items-center justify-center",children:e.jsx(F,{size:20,className:"text-indigo-600"})}),e.jsxs("div",{children:[e.jsx("h1",{className:"text-2xl font-bold text-gray-900",children:"Ficha de Matr\\u00edcula"}),e.jsx("p",{className:"text-gray-500",children:"Formul\\u00e1rio oficial para impress\\u00e3o"})]})]}),e.jsxs("div",{className:"flex gap-2",children:[e.jsxs("button",{onClick:()=>_(),className:"btn-secondary flex items-center gap-2",children:[e.jsx(D,{size:16})," Imprimir em Branco"]}),e.jsxs("button",{onClick:I,className:"btn-secondary flex items-center gap-2",children:[e.jsx(O,{size:16})," Exportar"]}),i&&e.jsxs("button",{onClick:()=>_(i),className:"btn-primary flex items-center gap-2",children:[e.jsx(D,{size:16})," Gerar PDF"]})]})]}),e.jsx(H,{selected:N,onChange:A}),e.jsxs("div",{className:"grid grid-cols-3 gap-6",children:[e.jsxs("div",{children:[e.jsxs("div",{className:"relative mb-3",children:[e.jsx(U,{size:15,className:"absolute left-3 top-1/2 -translate-y-1/2 text-gray-400"}),e.jsx("input",{className:"input pl-9",placeholder:"Buscar aluno...",value:p,onChange:t=>C(t.target.value)})]}),e.jsx("div",{className:"space-y-1 max-h-[65vh] overflow-y-auto",children:y.slice(0,50).map(t=>{var a;return e.jsxs("button",{onClick:()=>k(t),className:`w-full text-left p-3 rounded-xl transition-all flex items-center gap-3 ${(i==null?void 0:i.id)===t.id?"bg-indigo-50 border border-indigo-200":"hover:bg-gray-50 border border-transparent"}`,children:[e.jsx("div",{className:"w-9 h-9 rounded-full bg-indigo-100 flex items-center justify-center text-sm font-bold text-indigo-700 flex-shrink-0",children:(a=t.name)==null?void 0:a[0]}),e.jsxs("div",{className:"min-w-0",children:[e.jsx("p",{className:"text-sm font-medium truncate",children:t.name}),t.enrollment&&e.jsxs("p",{className:"text-xs text-gray-400",children:["Mat. ",t.enrollment]})]})]},t.id)})})]}),e.jsx("div",{className:"col-span-2",children:i?e.jsxs("div",{className:"card",children:[e.jsxs("div",{className:"flex items-center gap-4 mb-4 pb-4 border-b",children:[e.jsx("div",{className:"w-14 h-14 rounded-full bg-indigo-100 flex items-center justify-center text-xl font-bold text-indigo-700",children:(j=i.name)==null?void 0:j[0]}),e.jsxs("div",{children:[e.jsx("h2",{className:"text-lg font-bold text-gray-900",children:i.name}),e.jsxs("p",{className:"text-sm text-gray-500",children:[i.enrollment?"Mat. "+i.enrollment:""," · ",i.grade||""," · ",((S=m(i.schoolId))==null?void 0:S.name)||""]})]})]}),e.jsxs("p",{className:"text-sm text-gray-600 mb-4",children:["Clique em ",e.jsx("b",{children:'"Gerar PDF"'})," para gerar a ficha de matr\\u00edcula preenchida com os dados deste aluno, ou ",e.jsx("b",{children:'"Imprimir em Branco"'})," para um formul\\u00e1rio vazio."]}),e.jsx("div",{className:"grid grid-cols-2 gap-3",children:[["Nome",i.name],["Matrícula",i.enrollment||"--"],["Série",i.grade||"--"],["Turma",i.classRoom||"--"],["Nascimento",i.birthDate?new Date(i.birthDate).toLocaleDateString("pt-BR"):"--"],["Escola",(($=m(i.schoolId))==null?void 0:$.name)||"--"],["Contato 1",(i.emergencyContact1Name||"--")+" - "+(i.emergencyContact1Phone||"")],["Tipo Sanguíneo",i.bloodType||"--"]].map(([t,a])=>e.jsxs("div",{className:"p-3 bg-gray-50 rounded-lg",children:[e.jsx("p",{className:"text-xs text-gray-400",children:t}),e.jsx("p",{className:"text-sm font-medium",children:a})]},t))})]}):e.jsxs("div",{className:"card text-center py-20",children:[e.jsx(q,{size:48,className:"text-gray-200 mx-auto mb-3"}),e.jsx("p",{className:"text-gray-500",children:"Selecione um aluno ou imprima em branco"})]})})]}),e.jsx(Q,{open:!!r,onClose:()=>b(null),onExport:t=>{r!=null&&r.html&&V(t,[],r.html,r.filename),b(null)},title:r?"Exportar Relatorio":void 0})]})}export{ee as default};
