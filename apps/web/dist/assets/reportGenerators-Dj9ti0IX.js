import{g as h}from"./reportTemplate-p5nKJRUH.js";const L=["janeiro","fevereiro","março","abril","maio","junho","julho","agosto","setembro","outubro","novembro","dezembro"];function y(a){if(!a)return"--";const i=typeof a=="string"?new Date(a):a;return isNaN(i.getTime())?String(a):`${i.getDate().toString().padStart(2,"0")}/${(i.getMonth()+1).toString().padStart(2,"0")}/${i.getFullYear()}`}function O(a){if(!a)return"--";const i=typeof a=="string"?new Date(a):a;return isNaN(i.getTime())?String(a):`${i.getDate()} de ${L[i.getMonth()]} de ${i.getFullYear()}`}function e(a,i){return`<div class="field-row"><span class="field-label">${a}</span><span class="field-value">${i||"--"}</span></div>`}function g(a){return a==="morning"?"MATUTINO":a==="afternoon"?"VESPERTINO":a==="evening"?"NOTURNO":a||"--"}function U(a,i,r,t,l){const s=`
