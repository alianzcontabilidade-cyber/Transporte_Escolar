import{l as f,g as h}from"./reportTemplate-DaU5Hq9N.js";let n=null,c=null;async function b(i,t){return c===i&&n||(n=await f(i,t),c=i),n}function x(i,t,l,r,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(g=>"<td>"+(g??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
