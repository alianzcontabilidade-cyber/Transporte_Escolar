...
export default function Layout() {
  ...
  const allPages = [
    ...
    { code: '113', to: '/declarações', text: 'Declarações e Certidões', module: 'Gestão Escolar', desc: 'Matrícula, frequência, transferência, escolaridade', tags: 'declaracao certidao matricula frequência transferência', color: '#1E40AF' },
    // Pedagógico
    ...
    { code: '207', to: '/relatorio-frequência', text: 'Relatório Frequência', module: 'Ensino e Aprendizagem', desc: 'Presença por aluno e período', tags: 'presenca falta relatorio frequência percentual', color: '#7C3AED' },
    ...
    { code: '116', to: '/ocorrências', text: 'Ocorrências', module: 'Gestão Escolar', desc: 'Registro de ocorrências disciplinares', tags: 'ocorrência indisciplina atraso falta elogio advertencia', color: '#1E40AF' },
