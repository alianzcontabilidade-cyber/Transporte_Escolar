...
export default function Layout() {
  ...
  const allPages = [
    ...
    { code: '103', to: '/matriculas', text: 'Matrículas', module: 'Gestão Escolar', desc: 'Matrícula individual e em lote', tags: 'matricula enturmacao lote vaga', color: '#1E40AF' },
    { code: '104', to: '/turmas', text: 'Turmas', module: 'Gestão Escolar', desc: 'Gestão de turmas por escola e ano', tags: 'turma classe sala serie', color: '#1E40AF' },
    { code: '105', to: '/series', text: 'Séries', module: 'Gestão Escolar', desc: 'Níveis e etapas de ensino', tags: 'serie etapa nivel fundamental medio', color: '#1E40AF' },
    { code: '106', to: '/anos-letivos', text: 'Anos Letivos', module: 'Gestão Escolar', desc: 'Períodos letivos e status', tags: 'ano letivo periodo planejamento', color: '#1E40AF' },
    { code: '107', to: '/professores', text: 'Professores', module: 'Gestão Escolar', desc: 'Corpo docente, formação, contrato', tags: 'professor docente formacao cnh contrato', color: '#1E40AF' },
    { code: '108', to: '/lista-espera', text: 'Lista de Espera', module: 'Gestão Escolar', desc: 'Fila de vagas com convocação', tags: 'espera fila vaga convocacao', color: '#1E40AF' },
    { code: '109', to: '/remanejamento', text: 'Remanejamento', module: 'Gestão Escolar', desc: 'Transferir alunos entre turmas', tags: 'transferir turma remanejamento mover', color: '#1E40AF' },
    { code: '110', to: '/carteirinha', text: 'Carteirinha', module: 'Gestão Escolar', desc: 'Carteira estudantil com QR Code', tags: 'carteira estudantil impressao qr', color: '#1E40AF' },
    { code: '111', to: '/promocao', text: 'Promoção de Alunos', module: 'Gestão Escolar', desc: 'Promover aprovados para próxima série', tags: 'promover aprovado serie proxima', color: '#1E40AF' },
    { code: '112', to: '/historico-escolar', text: 'Histórico Escolar', module: 'Gestão Escolar', desc: 'Trajetória acadêmica do aluno', tags: 'historico trajetoria academica', color: '#1E40AF' },
    { code: '113', to: '/declaracoes', text: 'Declarações e Certidões', module: 'Gestão Escolar', desc: 'Matrícula, frequência, transferência, escolaridade', tags: 'declaracao certidao matricula frequência transferência', color: '#1E40AF' },
    // Pedagógico
    { code: '201', to: '/disciplinas', text: 'Disciplinas', module: 'Ensino e Aprendizagem', desc: 'Componentes curriculares BNCC', tags: 'materia componente bncc curricular disciplina', color: '#7C3AED' },
    { code: '202', to: '/diario-escolar', text: 'Diário Escolar', module: 'Ensino e Aprendizagem', desc: 'Frequência e conteúdo das aulas', tags: 'frequência conteudo aula diario presenca', color: '#7C3AED' },
    { code: '203', to: '/lancamento-notas', text: 'Lançar Notas', module: 'Ensino e Aprendizagem', desc: 'Notas por avaliação e bimestre', tags: 'nota avaliacao prova trabalho bimestre lancar', color: '#7C3AED' },
    { code: '204', to: '/boletim', text: 'Boletim Escolar', module: 'Ensino e Aprendizagem', desc: 'Consulta e impressão de boletins', tags: 'boletim nota media impressao resultado', color: '#7C3AED' },
    { code: '205', to: '/parecer-descritivo', text: 'Parecer Descritivo', module: 'Ensino e Aprendizagem', desc: 'Avaliação qualitativa por aluno', tags: 'parecer qualitativo descritivo texto', color: '#7C3AED' },
    { code: '206', to: '/ata-resultados', text: 'ATA de Resultados', module: 'Ensino e Aprendizagem', desc: 'Documento oficial de resultados finais', tags: 'ata resultado final aprovado retido', color: '#7C3AED' },
    { code: '207', to: '/relatorio-frequencia', text: 'Relatório Frequência', module: 'Ensino e Aprendizagem', desc: 'Presença por aluno e período', tags: 'presenca falta relatorio frequência percentual', color: '#7C3AED' },
    ...
    { code: '308', to: '/frequencia', text: 'Frequência Transporte', module: 'Frota e Rotas', desc: 'Embarque e desembarque de alunos', tags: 'embarque desembarque qr code presenca', color: '#0369A1' },
    ...
    { code: '403', to: '/contratos', text: 'Contratos', module: 'Gestão e Recursos', desc: 'Gestão de contratos e fornecedores', tags: 'contrato fornecedor licitacao vigencia', color: '#0F766E' },
    { code: '404', to: '/merenda', text: 'Merenda Escolar', module: 'Gestão e Recursos', desc: 'Cardápios, calorias e porções', tags: 'merenda cardapio alimentacao refeicao caloria', color: '#0F766E' },
    { code: '405', to: '/biblioteca', text: 'Biblioteca', module: 'Gestão e Recursos', desc: 'Acervo, empréstimos e devoluções', tags: 'livro acervo emprestimo biblioteca devolucao', color: '#0F766E' },
    { code: '406', to: '/patrimonio', text: 'Patrimônio e Estoque', module: 'Gestão e Recursos', desc: 'Bens, equipamentos e controle de estoque', tags: 'patrimonio bem estoque equipamento material', color: '#0F766E' },
    { code: '407', to: '/manutencao-preditiva', text: 'Manutenção', module: 'Gestão e Recursos', desc: 'Manutenção preventiva de veículos', tags: 'manutencao veiculo preventiva corretiva', color: '#0F766E' },
    { code: '408', to: '/relatorios', text: 'Relatórios', module: 'Gestão e Recursos', desc: 'Relatórios gerais com exportação', tags: 'relatorio exportar csv pdf geral', color: '#0F766E' },
    { code: '409', to: '/comunicacao', text: 'Comunicação', module: 'Gestão e Recursos', desc: 'Recados e avisos para a comunidade', tags: 'recado mensagem aviso comunicacao whatsapp', color: '#0F766E' },
    { code: '410', to: '/envio-massa', text: 'Envio em Massa', module: 'Gestão e Recursos', desc: 'WhatsApp em massa para responsáveis', tags: 'whatsapp envio massa responsavel pai sms', color: '#0F766E' },
    { code: '411', to: '/cotacao-compras', text: 'Cotação de Compras', module: 'Gestão e Recursos', desc: 'Compare preços de fornecedores', tags: 'cotacao compra preco fornecedor orcamento', color: '#0F766E' },
    // Configurações
    ...
    { code: '210', to: '/grade-horaria', text: 'Grade Horária', module: 'Ensino e Aprendizagem', desc: 'Horário de aulas por turma e dia', tags: 'grade horaria horario aula dia semana disciplina', color: '#7C3AED' },
    ...
    { code: '114', to: '/ficha-aluno', text: 'Ficha do Aluno', module: 'Gestão Escolar', desc: 'Ficha completa do aluno para impressão', tags: 'ficha aluno completa impressao dados', color: '#1E40AF' },
    { code: '115', to: '/relatorio-escola', text: 'Relatório por Escola', module: 'Gestão Escolar', desc: 'Visão completa de uma unidade escolar', tags: 'relatorio escola unidade alunos turmas', color: '#1E40AF' },
    ...
    { code: '211', to: '/conselho-classe', text: 'Conselho de Classe', module: 'Ensino e Aprendizagem', desc: 'Registro de decisões por aluno e bimestre', tags: 'conselho classe decisao aprovado retido recuperacao', color: '#7C3AED' },
    { code: '116', to: '/ocorrencias', text: 'Ocorrências', module: 'Gestão Escolar', desc: 'Registro de ocorrências disciplinares', tags: 'ocorrência indisciplina atraso falta elogio advertencia', color: '#1E40AF' },
    { code: '117', to: '/ficha-matricula', text: 'Ficha de Matrícula', module: 'Gestão Escolar', desc: 'Formulário oficial de matrícula para impressão', tags: 'ficha matricula formulario impressao requerimento', color: '#1E40AF' },
    ...
    { code: '511', to: '/declaracoes-admin', text: 'Declarações', module: 'Central de Controle', desc: 'Gerenciar tipos de declarações e responder solicitações dos pais', tags: 'declaracao matricula frequencia transferencia solicitacao pai responsavel', color: '#64748b' },
    ...
    { code: '416', to: '/central-relatorios', text: 'Central de Relatórios', module: 'Gestão e Recursos', desc: 'Todos os relatórios do sistema organizados por módulo', tags: 'central relatorio todos modulo ficha declaracao lista', color: '#0F766E' },
  ...
  const moduleBlocks = [
    { key: 'dashboard', label: 'Painel Central', icon: LayoutDashboard, color: '#059669', to: '/' },
    { key: 'secretaria', label: 'Gestão Escolar', icon: School, color: '#1E40AF', items: [
    ...
    { key: 'pedagogico', label: 'Ensino e Aprendizagem', icon: GraduationCap, color: '#7C3AED', items: [
    ...
    { key: 'administrativo', label: 'Gestão e Recursos', icon: Briefcase, color: '#0F766E', items: [
    ...
    { key: 'configurações', label: 'Central de Controle', icon: Settings, color: '#475569', items: [
