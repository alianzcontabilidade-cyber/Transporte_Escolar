...
const PAGE_CODES: Record<string, { code: string; title: string; module: string; color: string }> = {
  ...
  '/relatorio-frequência': { code: '207', title: 'Relatório Frequência', module: 'Ensino e Aprendizagem', color: '#8b5cf6' },
  ...
  '/frequência': { code: '308', title: 'Frequência Transporte', module: 'Frota e Rotas', color: '#f97316' },
  ...
  '/configurações': { code: '501', title: 'Usuários e Segurança', module: 'Central de Controle', color: '#64748b' },
  ...
  '/declarações': { code: '113', title: 'Declarações', module: 'Gestão Escolar', color: '#6366f1' },
  ...
  '/ocorrências': { code: '116', title: 'Ocorrências', module: 'Gestão Escolar', color: '#6366f1' },
