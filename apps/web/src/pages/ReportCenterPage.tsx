...
const MODULES = [
  { key: 'Gestão Escolar', label: 'Gestão Escolar', color: '#6366f1', icon: School, desc: 'Alunos, matrículas e documentos' },
  { key: 'Ensino e Aprendizagem', label: 'Ensino e Aprendizagem', color: '#8b5cf6', icon: GraduationCap, desc: 'Notas, frequência e avaliações' },
  { key: 'Frota e Rotas', label: 'Frota e Rotas', color: '#f97316', icon: Bus, desc: 'Transporte, veículos e motoristas' },
  { key: 'Gestão e Recursos', label: 'Gestão e Recursos', color: '#0ea5e9', icon: Briefcase, desc: 'Financeiro, contratos e operacional' },
];
...
const REPORTS: Report[] = [
  ...
  // Frota e Rotas
  { code: 'R301', title: 'Relatório de Viagens', desc: 'Histórico de viagens concluídas', module: 'Frota e Rotas', color: '#f97316', to: '/relatorio-transporte', icon: Bus, tags: ['viagem', 'transporte'] },
  { code: 'R302', title: 'Relatório da Frota', desc: 'Veículos, status e documentos', module: 'Frota e Rotas', color: '#f97316', to: '/relatorios', icon: Truck, tags: ['veiculo', 'frota', 'documento'] },
  { code: 'R303', title: 'Vistoria de Veículos', desc: 'Checklist de inspeção veicular', module: 'Frota e Rotas', color: '#f97316', to: '/vistoria-veiculos', icon: FileText, tags: ['vistoria', 'inspecao'] },
  ...
  { code: 'R308', title: 'Alunos Transportados (FNDE)', desc: 'Relatório FNDE com todos os alunos do transporte', module: 'Frota e Rotas', color: '#f97316', to: '/alunos-transportados', icon: Bus, tags: ['aluno', 'transportado', 'fnde', 'rota', 'rural'] },
  { code: 'R309', title: 'Quilometragem', desc: 'Km percorridos por veículo e rota', module: 'Frota e Rotas', color: '#f97316', to: '/quilometragem', icon: Truck, tags: ['quilometragem', 'km', 'veiculo', 'distancia'] },
  { code: 'R310', title: 'Abastecimento', desc: 'Controle de combustível da frota', module: 'Frota e Rotas', color: '#f97316', to: '/abastecimento', icon: Truck, tags: ['abastecimento', 'combustivel', 'diesel', 'litro'] },
  { code: 'R311', title: 'Manutenções', desc: 'Histórico de manutenções da frota', module: 'Frota e Rotas', color: '#f97316', to: '/relatorio-manutencoes', icon: Truck, tags: ['manutencao', 'preventiva', 'corretiva', 'custo'] },
  // Gestão e Recursos
  { code: 'R401', title: 'Relatório Financeiro', desc: 'Receitas, despesas e saldo', module: 'Gestão e Recursos', color: '#0ea5e9', to: '/financeiro', icon: TrendingUp, tags: ['financeiro', 'receita', 'despesa'] },
  { code: 'R402', title: 'Relatório de Contratos', desc: 'Contratos vigentes e vencidos', module: 'Gestão e Recursos', color: '#0ea5e9', to: '/contratos', icon: FileText, tags: ['contrato', 'fornecedor'] },
  { code: 'R403', title: 'Estoque da Merenda', desc: 'Itens, entradas e saídas', module: 'Gestão e Recursos', color: '#0ea5e9', to: '/estoque-merenda', icon: Briefcase, tags: ['merenda', 'estoque'] },
  { code: 'R404', title: 'Cotação de Compras', desc: 'Comparativo de fornecedores', module: 'Gestão e Recursos', color: '#0ea5e9', to: '/cotacao-compras', icon: Briefcase, tags: ['cotacao', 'compra'] },
  { code: 'R405', title: 'Protocolo', desc: 'Requerimentos e solicitações', module: 'Gestão e Recursos', color: '#0ea5e9', to: '/protocolo', icon: FileText, tags: ['protocolo', 'requerimento'] },
  { code: 'R406', title: 'Mural Informativo', desc: 'Comunicados e avisos', module: 'Gestão e Recursos', color: '#0ea5e9', to: '/mural', icon: FileText, tags: ['mural', 'comunicado'] },
