...
const REPORTS: Report[] = [
  ...
  { code: 'R104', title: 'Declaração de Matrícula', desc: 'Comprova matrícula ativa', module: 'Gestão Escolar', color: '#1E40AF', to: '/declaracoes', icon: FileText, tags: ['declaracao', 'matricula'] },
  { code: 'R105', title: 'Declaração de Transferência', desc: 'Para transferência entre escolas', module: 'Gestão Escolar', color: '#1E40AF', to: '/declaracoes', icon: FileText, tags: ['declaracao', 'transferência'] },
  { code: 'R106', title: 'Declaração de Frequência', desc: 'Comprova frequência escolar', module: 'Gestão Escolar', color: '#1E40AF', to: '/declaracoes', icon: FileText, tags: ['declaracao', 'frequência'] },
  ...
  { code: 'R111', title: 'Registro de Ocorrências', desc: 'Ocorrências disciplinares', module: 'Gestão Escolar', color: '#1E40AF', to: '/ocorrencias', icon: FileText, tags: ['ocorrência', 'disciplinar'] },
  ...
  { code: 'R205', title: 'Relatório de Frequência', desc: 'Presença por aluno e período', module: 'Ensino e Aprendizagem', color: '#7C3AED', to: '/relatorio-frequencia', icon: Users, tags: ['frequência', 'presenca'] },
