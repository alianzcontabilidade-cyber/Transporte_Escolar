...
export default function StudentCertificatesPage() {
  ...
  return (
    <div className="p-6">
      ...
      <ExportModal allowSign={true} open={!!certExportModal} onClose={() => setCertExportModal(null)} onExport={(fmt: ExportFormat, opts?: any) => { if (certExportModal?.html) { handleExport(fmt, [], certExportModal.html, certExportModal.filename, opts); } setCertExportModal(null); }} title="Exportar Declaracao" />
    </div>
  );
}
