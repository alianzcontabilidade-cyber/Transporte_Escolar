import{b as P,r as d,e as v,j as e,F as O,D as F,h as U,U as q,a as f,s as Y}from"./index-VCAQ5yfh.js";import{getMunicipalityReport as H,buildTableReportHTML as G}from"./reportUtils-QjxAA8Bp.js";import{P as E,R as Q,E as V,h as J}from"./reportTemplate-yQJhTdV8.js";import"./globe-wl5aNSjR.js";import"./check-f8nYE787.js";import"./chevron-up-Co_rCaxI.js";import"./chevron-down-BGt3bg8F.js";function ie(){var j,S,$;const{user:u}=P(),n=(u==null?void 0:u.municipalityId)||0,[p,C]=d.useState(""),[l,b]=d.useState(null),[D,z]=d.useState(null),[i,k]=d.useState(null),[N,A]=d.useState([]);d.useEffect(()=>{n&&H(n,f).then(z).catch(()=>{})},[n]);const{data:w}=v(()=>f.students.list({municipalityId:n}),[n]),{data:R}=v(()=>f.schools.list({municipalityId:n}),[n]),{data:T}=v(()=>f.municipalities.getById({id:n}),[n]),y=(w||[]).filter(t=>{var a;return!p||((a=t.name)==null?void 0:a.toLowerCase().includes(p.toLowerCase()))||(t.enrollment||"").includes(p)}),I=R||[],o=T,m=t=>I.find(a=>a.id===t),_=t=>{const a=t||{},c=m(a.schoolId),r=a.shift==="afternoon"?"Tarde":a.shift==="evening"?"Noite":a.shift?"Manhã":"________",x=h=>h?new Date(h).toLocaleDateString("pt-BR"):"____/____/________",s=(h,M,K)=>`<div class="field" style=""><div class="field-label">${h}</div><div class="field-value">${M||"_".repeat(40)}</div></div>`,L=`<!DOCTYPE html><html><head><meta charset="utf-8"><title>Ficha de Matrícula - NetEscol</title>
    <style>
