import{b as P,r as d,e as v,j as e,F as O,P as E,D as F,h as U,U as q,a as u}from"./index-RKzAL-KV.js";import{g as Y,b as H}from"./reportUtils-Chc7aFo5.js";import{R as G,E as Q,h as V}from"./reportTemplate-DdkF7Chb.js";import"./globe-BrnLtdNp.js";function ee(){var j,S,$;const{user:f}=P(),n=(f==null?void 0:f.municipalityId)||0,[p,C]=d.useState(""),[r,b]=d.useState(null),[D,z]=d.useState(null),[i,k]=d.useState(null),[N,A]=d.useState([]);d.useEffect(()=>{n&&Y(n,u).then(z).catch(()=>{})},[n]);const{data:w}=v(()=>u.students.list({municipalityId:n}),[n]),{data:R}=v(()=>u.schools.list({municipalityId:n}),[n]),{data:T}=v(()=>u.municipalities.getById({id:n}),[n]),y=(w||[]).filter(t=>{var a;return!p||((a=t.name)==null?void 0:a.toLowerCase().includes(p.toLowerCase()))||(t.enrollment||"").includes(p)}),I=R||[],o=T,m=t=>I.find(a=>a.id===t),_=t=>{const a=t||{},c=m(a.schoolId),l=a.shift==="afternoon"?"Tarde":a.shift==="evening"?"Noite":a.shift?"Manhã":"________",x=h=>h?new Date(h).toLocaleDateString("pt-BR"):"____/____/________",s=(h,M,J)=>`<div class="field" style=""><div class="field-label">${h}</div><div class="field-value">${M||"_".repeat(40)}</div></div>`,L=`<!DOCTYPE html><html><head><meta charset="utf-8"><title>Ficha de Matrícula - NetEscol</title>
    <style>
