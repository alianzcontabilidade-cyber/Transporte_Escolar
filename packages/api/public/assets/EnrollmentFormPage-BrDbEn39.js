import{b as P,r as d,e as v,j as e,F as O,D as F,h as U,U as q,a as u,s as Y}from"./index-BkUEHsAQ.js";import{getMunicipalityReport as H,buildTableReportHTML as G}from"./reportUtils-CQXUep63.js";import{P as E,R as Q,E as V,h as J}from"./reportTemplate-CZaRXygP.js";import"./globe-C5B4xnEk.js";import"./check-CrdFEvnJ.js";import"./chevron-up-DOEhwr87.js";import"./chevron-down-DNhbHwY9.js";function ie(){var j,S,$;const{user:f}=P(),n=(f==null?void 0:f.municipalityId)||0,[p,C]=d.useState(""),[l,b]=d.useState(null),[D,z]=d.useState(null),[i,k]=d.useState(null),[N,w]=d.useState([]);d.useEffect(()=>{n&&H(n,u).then(z).catch(()=>{})},[n]);const{data:A}=v(()=>u.students.list({municipalityId:n}),[n]),{data:R}=v(()=>u.schools.list({municipalityId:n}),[n]),{data:T}=v(()=>u.municipalities.getById({id:n}),[n]),y=(A||[]).filter(t=>{var a;return!p||((a=t.name)==null?void 0:a.toLowerCase().includes(p.toLowerCase()))||(t.enrollment||"").includes(p)}),I=R||[],o=T,m=t=>I.find(a=>a.id===t),_=t=>{const a=t||{},c=m(a.schoolId),r=a.shift==="afternoon"?"Tarde":a.shift==="evening"?"Noite":a.shift?"Manhã":"________",x=h=>h?new Date(h).toLocaleDateString("pt-BR"):"____/____/________",s=(h,M,K)=>`<div class="field" style=""><div class="field-label">${h}</div><div class="field-value">${M||"_".repeat(40)}</div></div>`,L=`<!DOCTYPE html><html><head><meta charset="utf-8"><title>Ficha de Matrícula - NetEscol</title>
    <style>
