import{b as J,at as K,r as n,e as $,j as e,F as W,l as X,i as Z,U as ee,a as y,s as B}from"./index--cXyFFnM.js";import{getMunicipalityReport as ae,buildTableReportHTML as se}from"./reportUtils-52ZrYYTG.js";import{R as te,a as ie}from"./reportTemplate-BTvVaIk9.js";import{c as oe}from"./reportGenerators-BIfApwdb.js";import{P as M,E as le,h as re}from"./ExportModal-VDtABW3p.js";import"./chevron-up-BUHicMvm.js";import"./chevron-down-BKQL0tNl.js";import"./globe-DsEKWp2P.js";import"./check-D7IlbNcn.js";import"./lock-CIcmElIU.js";function be(){var z,R,I;const{user:N}=J(),r=(N==null?void 0:N.municipalityId)||0,[P]=K(),j=P.get("studentId"),[x,L]=n.useState(""),[m,U]=n.useState(""),[_,w]=n.useState(""),[d,g]=n.useState(null),[h,F]=n.useState(null),[t,E]=n.useState(null),[S,O]=n.useState([]);n.useEffect(()=>{r&&ae(r,y).then(F).catch(()=>{})},[r]),n.useEffect(()=>{if(j&&f&&!t){const a=(f||[]).find(s=>String(s.id)===j);a&&E(a)}},[j,f]);const{data:f}=$(()=>y.students.list({municipalityId:r}),[r]),{data:q}=$(()=>y.schools.list({municipalityId:r}),[r]),{data:Y}=$(()=>y.municipalities.getById({id:r}),[r]),D=f||[],H=[...new Set(D.filter(a=>!m||String(a.schoolId)===m).map(a=>a.classRoom).filter(Boolean))].sort(),A=D.filter(a=>{var p;const s=!x||((p=a.name)==null?void 0:p.toLowerCase().includes(x.toLowerCase()))||(a.enrollment||"").includes(x),c=!m||String(a.schoolId)===m,l=!_||a.classRoom===_;return s&&c&&l}),C=q||[],o=Y,u=a=>C.find(s=>s.id===a),k=a=>{var T;const s=a||{},c=u(s.schoolId),l=s.shift==="afternoon"?"Tarde":s.shift==="evening"?"Noite":s.shift?"Manhã":"________",p=b=>b?new Date(b).toLocaleDateString("pt-BR"):"____/____/________",i=(b,V,ne)=>`<div class="field" style=""><div class="field-label">${b}</div><div class="field-value">${V||"_".repeat(40)}</div></div>`,Q=`<!DOCTYPE html><html><head><meta charset="utf-8"><title>Ficha de Matrícula - NetEscol</title>
    <style>
