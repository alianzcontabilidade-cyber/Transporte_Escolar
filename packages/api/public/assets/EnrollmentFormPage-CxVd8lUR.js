import{b as O,r as d,e as N,j as e,F,k as U,h as q,U as Y,a as b,s as D}from"./index-B1J3vCTL.js";import{getMunicipalityReport as H,buildTableReportHTML as G}from"./reportUtils-BnIzpAUe.js";import{P as A,R as Q,E as V,h as J,a as K}from"./reportTemplate-S_UNA_VL.js";import{b as W}from"./reportGenerators-BuB5mtCn.js";import"./globe-BHrhDnJ_.js";import"./check-BweZMGPD.js";import"./chevron-up-B2yet9id.js";import"./chevron-down-DUTX-0LJ.js";function le(){var C,$,E;const{user:v}=O(),l=(v==null?void 0:v.municipalityId)||0,[p,k]=d.useState(""),[r,m]=d.useState(null),[x,z]=d.useState(null),[s,w]=d.useState(null),[y,R]=d.useState([]);d.useEffect(()=>{l&&H(l,b).then(z).catch(()=>{})},[l]);const{data:I}=N(()=>b.students.list({municipalityId:l}),[l]),{data:T}=N(()=>b.schools.list({municipalityId:l}),[l]),{data:M}=N(()=>b.municipalities.getById({id:l}),[l]),_=(I||[]).filter(i=>{var a;return!p||((a=i.name)==null?void 0:a.toLowerCase().includes(p.toLowerCase()))||(i.enrollment||"").includes(p)}),j=T||[],o=M,g=i=>j.find(a=>a.id===i),S=i=>{const a=i||{},c=g(a.schoolId),n=a.shift==="afternoon"?"Tarde":a.shift==="evening"?"Noite":a.shift?"Manhã":"________",h=u=>u?new Date(u).toLocaleDateString("pt-BR"):"____/____/________",t=(u,P,X)=>`<div class="field" style=""><div class="field-label">${u}</div><div class="field-value">${P||"_".repeat(40)}</div></div>`,L=`<!DOCTYPE html><html><head><meta charset="utf-8"><title>Ficha de Matrícula - NetEscol</title>
    <style>
