import{b as Q,r as c,e as S,j as e,F as V,l as J,i as K,U as W,a as b,s as R}from"./index-CdDz-iao.js";import{getMunicipalityReport as X,buildTableReportHTML as Z}from"./reportUtils-RG3unk9n.js";import{R as ee,a as ae}from"./reportTemplate-4j6rOazo.js";import{c as se}from"./reportGenerators-D350AW2j.js";import{P as I,E as te,h as ie}from"./ExportModal-B8ioaGWd.js";import"./chevron-up-B8hlOX3D.js";import"./chevron-down-B2wD7CAl.js";import"./globe-D93UyKgG.js";import"./check-Db2ZVu77.js";function he(){var D,A,k;const{user:y}=Q(),r=(y==null?void 0:y.municipalityId)||0,[x,T]=c.useState(""),[m,B]=c.useState(""),[N,C]=c.useState(""),[d,g]=c.useState(null),[h,M]=c.useState(null),[t,L]=c.useState(null),[j,P]=c.useState([]);c.useEffect(()=>{r&&X(r,b).then(M).catch(()=>{})},[r]);const{data:U}=S(()=>b.students.list({municipalityId:r}),[r]),{data:F}=S(()=>b.schools.list({municipalityId:r}),[r]),{data:O}=S(()=>b.municipalities.getById({id:r}),[r]),$=U||[],q=[...new Set($.filter(a=>!m||String(a.schoolId)===m).map(a=>a.classRoom).filter(Boolean))].sort(),w=$.filter(a=>{var p;const s=!x||((p=a.name)==null?void 0:p.toLowerCase().includes(x.toLowerCase()))||(a.enrollment||"").includes(x),n=!m||String(a.schoolId)===m,l=!N||a.classRoom===N;return s&&n&&l}),_=F||[],o=O,f=a=>_.find(s=>s.id===a),E=a=>{var z;const s=a||{},n=f(s.schoolId),l=s.shift==="afternoon"?"Tarde":s.shift==="evening"?"Noite":s.shift?"Manhã":"________",p=v=>v?new Date(v).toLocaleDateString("pt-BR"):"____/____/________",i=(v,G,oe)=>`<div class="field" style=""><div class="field-label">${v}</div><div class="field-value">${G||"_".repeat(40)}</div></div>`,H=`<!DOCTYPE html><html><head><meta charset="utf-8"><title>Ficha de Matrícula - NetEscol</title>
    <style>
    ...
    <div class="header">
      ...
      <h1>${(n==null?void 0:n.name)||(o==null?void 0:o.name)||"UNIDADE ESCOLAR"}</h1>
