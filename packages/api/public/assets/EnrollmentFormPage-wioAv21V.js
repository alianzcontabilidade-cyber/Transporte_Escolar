import{b as J,at as K,r as n,f as $,j as e,F as W,n as X,l as Z,U as ee,a as y,s as B}from"./index-BlohmxBZ.js";import{getMunicipalityReport as ae,buildTableReportHTML as se}from"./reportUtils-DsB2mdru.js";import{R as te,a as ie}from"./reportTemplate-j2yUlUrQ.js";import{c as oe}from"./reportGenerators-CXBQLOie.js";import{P as M,E as le,h as re}from"./ExportModal-Cnj0w3QA.js";import"./chevron-up-CmjtxD0Y.js";import"./chevron-down-Cco9ufKf.js";import"./globe-Qwhj9skH.js";import"./check-Cegf8Ds6.js";import"./lock-DPH9b56X.js";function be(){var z,R,I;const{user:N}=J(),r=(N==null?void 0:N.municipalityId)||0,[P]=K(),j=P.get("studentId"),[x,L]=n.useState(""),[m,U]=n.useState(""),[_,w]=n.useState(""),[d,g]=n.useState(null),[h,F]=n.useState(null),[t,E]=n.useState(null),[S,O]=n.useState([]);n.useEffect(()=>{r&&ae(r,y).then(F).catch(()=>{})},[r]),n.useEffect(()=>{if(j&&f&&!t){const a=(f||[]).find(s=>String(s.id)===j);a&&E(a)}},[j,f]);const{data:f}=$(()=>y.students.list({municipalityId:r}),[r]),{data:q}=$(()=>y.schools.list({municipalityId:r}),[r]),{data:Y}=$(()=>y.municipalities.getById({id:r}),[r]),D=f||[],H=[...new Set(D.filter(a=>!m||String(a.schoolId)===m).map(a=>a.classRoom).filter(Boolean))].sort(),A=D.filter(a=>{var p;const s=!x||((p=a.name)==null?void 0:p.toLowerCase().includes(x.toLowerCase()))||(a.enrollment||"").includes(x),c=!m||String(a.schoolId)===m,l=!_||a.classRoom===_;return s&&c&&l}),C=q||[],o=Y,u=a=>C.find(s=>s.id===a),k=a=>{var T;const s=a||{},c=u(s.schoolId),l=s.shift==="afternoon"?"Tarde":s.shift==="evening"?"Noite":s.shift?"Manhã":"________",p=b=>b?new Date(b).toLocaleDateString("pt-BR"):"____/____/________",i=(b,V,ne)=>`<div class="field" style=""><div class="field-label">${b}</div><div class="field-value">${V||"_".repeat(40)}</div></div>`,Q=`<!DOCTYPE html><html><head><meta charset="utf-8"><title>Ficha de Matrícula - NetEscol</title>
    <style>
    ...
    <div style="display:flex;gap:12px;align-items:flex-start">
      <div style="width:70px;height:85px;border:1px solid #ccc;border-radius:6px;overflow:hidden;flex-shrink:0;display:flex;align-items:center;justify-content:center;background:#f3f4f6">
        ${s.photoUrl?'<img src="'+s.photoUrl+'" style="width:100%;height:100%;object-fit:cover"/>':'<span style="font-size:28px;color:#999">'+(((T=s.name)==null?void 0:T[0])||"?")+"</span>"}
      </div>
      <div style="flex:1">
    ...
    </body></html>`,v=window.open("","_blank");v&&(v.document.write(Q),v.document.close(),setTimeout(()=>v.print(),500))},G=()=>{if(t&&h){const a=ie(t.schoolId,C),s=oe(t,a,h.municipality,h.secretaria,S);if(!s){B("Erro ao gerar ficha");return}g({html:s,filename:"ficha_matricula_"+(t.name||"").replace(/\s/g,"_")})}else{const a=A.map(l=>{var p;return{nome:l.name||"--",matrícula:l.enrollment||"--",serie:l.grade||"--",turma:l.classRoom||"--",turno:l.shift==="afternoon"?"Tarde":l.shift==="evening"?"Noite":l.shift==="full_time"?"Integral":"Manhã",escola:((p=u(l.schoolId))==null?void 0:p.name)||"--"}}),c=se("LISTA DE ALUNOS MATRICULADOS",a,["Nome","Matricula","Serie","Turma","Turno","Escola"],h,{orientation:"landscape",signatories:S});if(!c){B("Nenhum dado para exportar");return}g({html:c,filename:"lista_alunos_matriculados"})}};return e.jsxs("div",{className:"p-6",children:[e.jsxs("div",{className:"flex items-center justify-between mb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("div",{className:"w-10 h-10 rounded-xl bg-indigo-100 flex items-center justify-center",children:e.jsx(W,{size:20,className:"text-indigo-600"})}),e.jsxs("div",{children:[e.jsx("h1",{className:"text-2xl font-bold text-gray-900",children:"Ficha de Matrícula"}),e.jsx("p",{className:"text-gray-500",children:"Formulário oficial para impressão"})]})]}),e.jsxs("div",{className:"flex gap-2",children:[e.jsxs("button",{onClick:()=>k(),className:"btn-secondary flex items-center gap-2",children:[e.jsx(M,{size:16})," Imprimir em Branco"]}),t&&e.jsxs("button",{onClick:()=>k(t),className:"btn-primary flex items-center gap-2",children:[e.jsx(M,{size:16})," Imprimir Preenchida"]}),e.jsxs("button",{onClick:G,className:"btn-secondary flex items-center gap-2",children:[e.jsx(X,{size:16})," Exportar"]})]})]}),e.jsx(te,{selected:S,onChange:O}),e.jsxs("div",{className:"grid grid-cols-3 gap-6",children:[e.jsxs("div",{children:[e.jsxs("select",{className:"input mb-2 text-sm",value:m,onChange:a=>{U(a.target.value),w("")},children:[e.jsx("option",{value:"",children:"Todas as escolas"}),C.map(a=>e.jsx("option",{value:a.id,children:a.name},a.id))]}),e.jsxs("select",{className:"input mb-2 text-sm",value:_,onChange:a=>w(a.target.value),children:[e.jsx("option",{value:"",children:"Todas as turmas"}),H.map(a=>e.jsx("option",{value:a,children:a},a))]}),e.jsxs("div",{className:"relative mb-3",children:[e.jsx(Z,{size:15,className:"absolute left-3 top-1/2 -translate-y-1/2 text-gray-400"}),e.jsx("input",{className:"input pl-9",placeholder:"Buscar aluno...",value:x,onChange:a=>L(a.target.value)})]}),e.jsx("div",{className:"space-y-1 max-h-[65vh] overflow-y-auto",children:A.slice(0,50).map(a=>{var s;return e.jsxs("button",{onClick:()=>E(a),className:`w-full text-left p-3 rounded-xl transition-all flex items-center gap-3 ${(t==null?void 0:t.id)===a.id?"bg-indigo-50 border border-indigo-200":"hover:bg-gray-50 border border-transparent"}`,children:[e.jsx("div",{className:"w-9 h-9 rounded-full bg-indigo-100 flex items-center justify-center text-sm font-bold text-indigo-700 flex-shrink-0 overflow-hidden",children:a.photoUrl?e.jsx("img",{src:a.photoUrl,className:"w-full h-full object-cover"}):(s=a.name)==null?void 0:s[0]}),e.jsxs("div",{className:"min-w-0",children:[e.jsx("p",{className:"text-sm font-medium truncate",children:a.name}),a.enrollment&&e.jsxs("p",{className:"text-xs text-gray-400",children:["Mat. ",a.enrollment]})]})]},a.id)})})]}),e.jsx("div",{className:"col-span-2",children:t?e.jsxs("div",{className:"card",children:[e.jsxs("div",{className:"flex items-center gap-4 mb-4 pb-4 border-b",children:[e.jsx("div",{className:"w-14 h-14 rounded-full bg-indigo-100 flex items-center justify-center text-xl font-bold text-indigo-700 overflow-hidden",children:t.photoUrl?e.jsx("img",{src:t.photoUrl,className:"w-full h-full object-cover"}):(z=t.name)==null?void 0:z[0]}),e.jsxs("div",{children:[e.jsx("h2",{className:"text-lg font-bold text-gray-900",children:t.name}),e.jsxs("p",{className:"text-sm text-gray-500",children:[t.enrollment?"Mat. "+t.enrollment:""," · ",t.grade||""," · ",((R=u(t.schoolId))==null?void 0:R.name)||""]})]})]}),e.jsxs("p",{className:"text-sm text-gray-600 mb-4",children:["Clique em ",e.jsx("b",{children:'"Imprimir Preenchida"'})," para imprimir a ficha com os dados deste aluno, ou ",e.jsx("b",{children:'"Imprimir em Branco"'})," para um formulario vazio. Use ",e.jsx("b",{children:'"Exportar"'})," para outros formatos."]}),e.jsx("div",{className:"grid grid-cols-2 gap-3",children:[["Nome",t.name],["Matricula",t.enrollment||"--"],["Serie",t.grade||"--"],["Turma",t.classRoom||"--"],["Nascimento",t.birthDate?new Date(t.birthDate).toLocaleDateString("pt-BR"):"--"],["Escola",((I=u(t.schoolId))==null?void 0:I.name)||"--"],["Contato 1",(t.emergencyContact1Name||"--")+" - "+(t.emergencyContact1Phone||"")],["Tipo Sanguineo",t.bloodType||"--"]].map(([a,s])=>e.jsxs("div",{className:"p-3 bg-gray-50 rounded-lg",children:[e.jsx("p",{className:"text-xs text-gray-400",children:a}),e.jsx("p",{className:"text-sm font-medium",children:s})]},a))})]}):e.jsxs("div",{className:"card text-center py-20",children:[e.jsx(ee,{size:48,className:"text-gray-200 mx-auto mb-3"}),e.jsx("p",{className:"text-gray-500",children:"Selecione um aluno ou imprima em branco"})]})})]}),e.jsx(le,{allowSign:!0,open:!!d,onClose:()=>g(null),onExport:(a,s)=>{d!=null&&d.html&&re(a,[],d.html,d.filename,s),g(null)},title:d?"Exportar Relatório":void 0})]})}export{be as default};
