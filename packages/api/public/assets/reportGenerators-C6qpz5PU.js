import{g as v}from"./reportTemplate-BmElJlXQ.js";const M=["janeiro","fevereiro","março","abril","maio","junho","julho","agosto","setembro","outubro","novembro","dezembro"];function O(a){if(!a)return"--";const o=typeof a=="string"?new Date(a):a;return isNaN(o.getTime())?String(a):`${o.getDate().toString().padStart(2,"0")}/${(o.getMonth()+1).toString().padStart(2,"0")}/${o.getFullYear()}`}function D(a){if(!a)return"--";const o=typeof a=="string"?new Date(a):a;return isNaN(o.getTime())?String(a):`${o.getDate()} de ${M[o.getMonth()]} de ${o.getFullYear()}`}function e(a,o){return`<div class="field-row"><span class="field-label">${a}</span><span class="field-value">${o||"--"}</span></div>`}function g(a){return a==="morning"?"MATUTINO":a==="afternoon"?"VESPERTINO":a==="evening"?"NOTURNO":a||"--"}function U(a,o,r,t,l){o!=null&&o.name;const s=`
