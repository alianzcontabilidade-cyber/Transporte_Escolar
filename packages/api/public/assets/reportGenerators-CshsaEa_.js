import{g as S}from"./reportTemplate-CLXsOz1S.js";const P=["janeiro","fevereiro","março","abril","maio","junho","julho","agosto","setembro","outubro","novembro","dezembro"];function T(e){if(!e)return"--";const i=typeof e=="string"?new Date(e):e;return isNaN(i.getTime())?String(e):`${i.getDate().toString().padStart(2,"0")}/${(i.getMonth()+1).toString().padStart(2,"0")}/${i.getFullYear()}`}function M(e){if(!e)return"--";const i=typeof e=="string"?new Date(e):e;return isNaN(i.getTime())?String(e):`${i.getDate()} de ${P[i.getMonth()]} de ${i.getFullYear()}`}function a(e,i){return`<div class="field-row"><span class="field-label">${e}</span><span class="field-value">${i||"--"}</span></div>`}function A(e){return e==="morning"?"MATUTINO":e==="afternoon"?"VESPERTINO":e==="evening"?"NOTURNO":e==="full_time"?"INTEGRAL":e||"--"}function L(e){if(!e)return"";const i=e.toLowerCase();return i.includes("berçário")||i.includes("bercario")||i.includes("maternal")||i.includes("jardim")||i.includes("pré")||i.includes("pre")||i.includes("creche")||i.includes("infantil")?"EDUCAÇÃO INFANTIL":i.includes("6º")||i.includes("7º")||i.includes("8º")||i.includes("9º")||i.includes("6 ano")||i.includes("7 ano")||i.includes("8 ano")||i.includes("9 ano")?"ENSINO FUNDAMENTAL – 6º ao 9º Ano":i.includes("1º")||i.includes("2º")||i.includes("3º")||i.includes("4º")||i.includes("5º")||i.includes("1 ano")||i.includes("2 ano")||i.includes("3 ano")||i.includes("4 ano")||i.includes("5 ano")?"ENSINO FUNDAMENTAL – 1º ao 5º Ano":i.includes("médio")||i.includes("medio")||i.includes("1ª série")||i.includes("2ª série")||i.includes("3ª série")?"ENSINO MÉDIO":i.includes("eja")||i.includes("supletivo")?"EDUCAÇÃO DE JOVENS E ADULTOS (EJA)":"ENSINO FUNDAMENTAL"}function w(e,i,l,n,d){const f=L(e.grade),s=new Date().getFullYear(),c=e.sex==="M"?"o":e.sex==="F"?"a":"o(a)",v=e.sex==="M"?"filho":e.sex==="F"?"filha":"filho(a)",$=e.sex==="M"?"nascido":e.sex==="F"?"nascida":"nascido(a)",m=e.naturalness?`natural de <b>${e.naturalness}${e.naturalnessUf?" – "+e.naturalnessUf:""}</b>, `:"",r=`
    <p class="declaration-text">
      ...
      é alun${c} deste Estabelecimento de Ensino, está cursando
    ...
    <p class="declaration-text">
      Declaramos, outrossim, que ${c==="o"?"o":"a"} referid${c} alun${c} encontra-se com a situação acadêmica
      regular perante esta instituição de ensino, nada constando em seus registros que ${c==="o"?"o":"a"} desabone.
    </p>
    <p class="declaration-text">
  ...
  `;return S({municipality:l,secretaria:n,school:i,title:"DECLARAÇÃO DE ESCOLARIDADE",content:r,signatories:d,fontFamily:"serif",fontSize:13})}function B(e,i,l,n,d,f){const s=`
    <p class="declaration-text">
  ...
  `;return S({municipality:l,secretaria:n,school:i,title:"DECLARAÇÃO DE TRANSFERÊNCIA",content:s,signatories:d,fontFamily:"serif",fontSize:13})}function _(e,i,l,n,d,f){const s=`
    <p class="declaration-text">
      Declaramos, para os devidos fins e efeitos legais, que <b>${e.name||"ALUNO(A)"}</b>,
  ...
  `;return S({municipality:l,secretaria:n,school:i,title:"DECLARAÇÃO DE FREQUÊNCIA",content:s,signatories:d,fontFamily:"serif",fontSize:13})}function q(e,i,l,n,d,f,s){const c=s||new Date().getFullYear();let v=`<div class="student-info">
    ...
    <div class="si-detail">Ano Letivo: ${c}${e.birthDate?" | Data de Nascimento: "+T(e.birthDate):""}</div>
  </div>`,$="",m=0,r=0;for(const o of i){const g=o.b1??o.bim1??"--",y=o.b2??o.bim2??"--",t=o.b3??o.bim3??"--",h=o.b4??o.bim4??"--",N=[g,y,t,h].map(b=>typeof b=="number"?b:parseFloat(b)).filter(b=>!isNaN(b)),p=N.length>0?N.reduce((b,F)=>b+F,0)/N.length:null,I=o.faltas??o.absences??"--",E=p!==null?p>=6?"Aprovado":p>=0?"Reprovado":"--":"--",R=E==="Aprovado"?"approved":E==="Reprovado"?"failed":"";p!==null&&(m+=p,r++),$+=`<tr>
  ...
  `;return S({municipality:n,secretaria:d,school:l,title:"BOLETIM ESCOLAR",subtitle:`Ano Letivo ${c}`,content:v+C,signatories:f,fontFamily:"sans-serif",fontSize:12})}function H(e,i,l,n,d,f){var D,C;const s=L(e.grade),c=`
  ...
  `;let m="";const r=i.filter(o=>o.grades&&o.grades.length>0);if(r.length>0)for(const o of r){let g="",y=0;for(const t of o.grades||[]){const h=t.b1??t.bim1??"--",O=t.b2??t.bim2??"--",N=t.b3??t.bim3??"--",p=t.b4??t.bim4??"--",E=[h,O,N,p].map(u=>typeof u=="number"?u:parseFloat(u)).filter(u=>!isNaN(u)),R=E.length>0?E.reduce((u,U)=>u+U,0)/E.length:null,b=t.cargaHoraria||t.weeklyHours?(t.weeklyHours||0)*40:80;y+=b;const F=t.faltas??t.absences??"--";g+=`<tr>
          ...
          <td style="font-size:9px">${typeof p=="number"?p.toFixed(1):p}</td>
  ...
  `;return S({municipality:n,secretaria:d,school:l,title:"HISTÓRICO ESCOLAR",subtitle:s||void 0,content:c+$+m+x,signatories:f,fontFamily:"sans-serif",fontSize:11})}function k(e,i,l,n,d){var s;const f=`
  ...
  </div>`;let c="",v=0,$=0;e.sort((r,x)=>(r.name||"").localeCompare(x.name||"")),e.forEach((r,x)=>{r.sex==="M"?v++:r.sex==="F"&&$++,c+=`<tr>
      <td>${x+1}</td>
  ...
  `;return S({municipality:n,secretaria:d,school:l,title:"RELAÇÃO DE ALUNOS MATRICULADOS POR TURMA",subtitle:`${i.grade} - Turma ${i.className} - ${A(i.shift)} - ${i.year}`,content:s+m,signatories:f,fontFamily:"sans-serif",fontSize:11})}export{H as a,k as b,_ as c,B as d,w as e,G as f,q as g};
