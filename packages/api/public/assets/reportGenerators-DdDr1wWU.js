import{g as O}from"./reportTemplate-Cnp55fJT.js";const P=["janeiro","fevereiro","março","abril","maio","junho","julho","agosto","setembro","outubro","novembro","dezembro"];function D(e){if(!e)return"--";const a=typeof e=="string"?new Date(e):e;return isNaN(a.getTime())?String(e):`${a.getDate().toString().padStart(2,"0")}/${(a.getMonth()+1).toString().padStart(2,"0")}/${a.getFullYear()}`}function L(e){if(!e)return"--";const a=typeof e=="string"?new Date(e):e;return isNaN(a.getTime())?String(e):`${a.getDate()} de ${P[a.getMonth()]} de ${a.getFullYear()}`}function i(e,a){return`<div class="field-row"><span class="field-label">${e}</span><span class="field-value">${a||"--"}</span></div>`}function A(e){return e==="morning"?"MATUTINO":e==="afternoon"?"VESPERTINO":e==="evening"?"NOTURNO":e||"--"}function I(e){if(!e)return"";const a=e.toLowerCase();return a.includes("berçário")||a.includes("bercario")||a.includes("maternal")||a.includes("jardim")||a.includes("pré")||a.includes("pre")||a.includes("creche")||a.includes("infantil")?"EDUCAÇÃO INFANTIL":a.includes("6º")||a.includes("7º")||a.includes("8º")||a.includes("9º")||a.includes("6 ano")||a.includes("7 ano")||a.includes("8 ano")||a.includes("9 ano")?"ENSINO FUNDAMENTAL – 6º ao 9º Ano":a.includes("1º")||a.includes("2º")||a.includes("3º")||a.includes("4º")||a.includes("5º")||a.includes("1 ano")||a.includes("2 ano")||a.includes("3 ano")||a.includes("4 ano")||a.includes("5 ano")?"ENSINO FUNDAMENTAL – 1º ao 5º Ano":a.includes("médio")||a.includes("medio")||a.includes("1ª série")||a.includes("2ª série")||a.includes("3ª série")?"ENSINO MÉDIO":a.includes("eja")||a.includes("supletivo")?"EDUCAÇÃO DE JOVENS E ADULTOS (EJA)":"ENSINO FUNDAMENTAL"}function z(e,a,l,n,s){const f=I(e.grade),m=new Date().getFullYear(),d=e.sex==="M"?"o":e.sex==="F"?"a":"o(a)",$=e.sex==="M"?"filho":e.sex==="F"?"filha":"filho(a)",g=e.sex==="M"?"nascido":e.sex==="F"?"nascida":"nascido(a)",b=e.naturalness?`natural de <b>${e.naturalness}${e.naturalnessUf?" – "+e.naturalnessUf:""}</b>, `:"",t=`
  ...
  `;return O({municipality:l,secretaria:n,school:a,title:"DECLARAÇÃO DE FREQUÊNCIA",content:m,signatories:s,fontFamily:"serif",fontSize:13})}function H(e,a,l,n,s,f,m){const d=m||new Date().getFullYear();let $=`<div class="student-info">
    ...
    <div class="si-detail">Ano Letivo: ${d}${e.birthDate?" | Data de Nascimento: "+D(e.birthDate):""}</div>
      ...
      <td>${M}</td>
      <td class="${R}">${E}</td>
    </tr>`}const u=t>0?(b/t).toFixed(1):"--",T=t>0&&b/t>=6?"APROVADO(A)":t>0?"REPROVADO(A)":"--",C=`
  ...
  `;return O({municipality:n,secretaria:s,school:l,title:"BOLETIM ESCOLAR",subtitle:`Ano Letivo ${d}`,content:$+C,signatories:f,fontFamily:"sans-serif",fontSize:12})}function k(e,a,l,n,s,f){var T,C;const m=I(e.grade),d=`
  ...
  `;let $="";for(const o of a){const v=(T=o.result)!=null&&T.toLowerCase().includes("aprov")?"approved":(C=o.result)!=null&&C.toLowerCase().includes("reprov")?"failed":"";$+=`<tr>
      <td>${o.year}</td>
  ...
  `;let b="";const t=a.filter(o=>o.grades&&o.grades.length>0);if(t.length>0)for(const o of t){let v="",y=0;for(const r of o.grades||[]){const h=r.b1??r.bim1??"--",S=r.b2??r.bim2??"--",N=r.b3??r.bim3??"--",c=r.b4??r.bim4??"--",E=[h,S,N,c].map(x=>typeof x=="number"?x:parseFloat(x)).filter(x=>!isNaN(x)),R=E.length>0?E.reduce((x,U)=>x+U,0)/E.length:null,p=r.cargaHoraria||r.weeklyHours?(r.weeklyHours||0)*40:80;y+=p;const F=r.faltas??r.absences??"--";v+=`<tr>
  ...
  `;return O({municipality:n,secretaria:s,school:l,title:"HISTÓRICO ESCOLAR",subtitle:m||void 0,content:d+g+b+u,signatories:f,fontFamily:"sans-serif",fontSize:11})}function V(e,a,l,n,s){const f=`
  ...
  `;return O({municipality:n,secretaria:s,school:l,title:"RELAÇÃO DE ALUNOS MATRICULADOS POR TURMA",subtitle:`${a.grade} - Turma ${a.className} - ${A(a.shift)} - ${a.year}`,content:m+b,signatories:f,fontFamily:"sans-serif",fontSize:11})}export{k as a,V as b,q as c,B as d,z as e,G as f,H as g};
