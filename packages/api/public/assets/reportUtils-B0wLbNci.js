import{l as g,g as f}from"./reportTemplate-Bt0txTAj.js";import"./index-V8R6qYHJ.js";import"./globe-By1BPYFy.js";import"./check-D28sguz-.js";import"./chevron-up-DAAG5yBf.js";import"./chevron-down-CfMCLlN2.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
