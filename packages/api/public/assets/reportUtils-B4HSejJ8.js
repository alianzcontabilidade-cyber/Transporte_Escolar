import{l as g,g as f}from"./reportTemplate-BuLaCyUT.js";import"./index-CkCMSSqx.js";import"./globe-DO6dPSym.js";import"./check-CcgdbcWi.js";import"./chevron-up-gAbUG7mE.js";import"./chevron-down-1Wd-935F.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
