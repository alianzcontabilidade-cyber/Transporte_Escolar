import{l as m,g as f}from"./reportTemplate-V2ubLByb.js";import"./index-Nn2dW0zx.js";import"./globe-BksluLu2.js";import"./chevron-up-CLIayb--.js";import"./chevron-down-xGezo9KO.js";let r=null,c=null;async function s(i,t){return c===i&&r||(r=await m(i,t),c=i),r}function y(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(g=>"<td>"+(g??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
