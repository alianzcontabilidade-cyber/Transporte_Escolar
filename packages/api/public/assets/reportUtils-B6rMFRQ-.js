import{l as g,g as f}from"./reportTemplate-CCCi8dW_.js";import"./index-CHgi6DyQ.js";import"./globe-rITIJ4Mj.js";import"./check-q6PyvpAq.js";import"./chevron-up-DoYfCuen.js";import"./chevron-down-DTsASwHH.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
