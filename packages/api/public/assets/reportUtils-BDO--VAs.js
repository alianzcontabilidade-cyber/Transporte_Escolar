import{l as g,g as f}from"./reportTemplate-B6jIdF9u.js";import"./index-f9cr0uIr.js";import"./globe-BYRyiXY_.js";import"./check-BY01xrOi.js";import"./chevron-up-D9Q_za5B.js";import"./chevron-down-CuKVtF-a.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
