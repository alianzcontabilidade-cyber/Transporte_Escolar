import{l as f,g as h}from"./reportTemplate-4-KcuH-Y.js";let n=null,c=null;async function b(i,t){return c===i&&n||(n=await f(i,t),c=i),n}function x(i,t,l,r,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(g=>"<td>"+(g??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
  ...
  `;return r?h({municipality:r.municipality,secretaria:r.secretaria,title:i.toUpperCase(),subtitle:(e==null?void 0:e.subtitle)||t.length+" registro(s)",content:o,signatories:e==null?void 0:e.signatories,orientation:(e==null?void 0:e.orientation)||(l.length>6?"landscape":"portrait"),fontSize:(e==null?void 0:e.fontSize)||11,fontFamily:"sans-serif"}):`<!DOCTYPE html><html><head><meta charset="utf-8"><title>${i}</title>
    ...
    </head><body><h1>${i}</h1>${o}<div class="footer">NetEscol - ${new Date().toLocaleDateString("pt-BR")}</div></body></html>`}export{x as b,b as g};
