import{l as g,g as f}from"./reportTemplate-CRt__wx6.js";import"./index-Dy-5vJto.js";import"./globe-CVAtyEU6.js";import"./check-BaVRFju5.js";import"./chevron-up-Dlb1B__-.js";import"./chevron-down-CQ1aOCL9.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
