import{l as g,g as f}from"./reportTemplate-w2uIh-z4.js";import"./index-D7SmmNEA.js";import"./globe-D7iQgYHg.js";import"./check-Bk6yBRky.js";import"./chevron-up-DoQQ2E5e.js";import"./chevron-down-BS9_W9Jt.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
