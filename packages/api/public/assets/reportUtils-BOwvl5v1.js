import{l as g,g as f}from"./reportTemplate-CZ6wzBVs.js";import"./index-CituZm9X.js";import"./globe-DMAfsW2Y.js";import"./check-BTdkVGqm.js";import"./chevron-up-DIm3nd6u.js";import"./chevron-down-DOsh5DOl.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
