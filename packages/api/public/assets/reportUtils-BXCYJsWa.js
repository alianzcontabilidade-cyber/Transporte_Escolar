import{l as g,g as f}from"./reportTemplate-jb_U4Kvx.js";import"./index-Brx4vuX6.js";import"./globe-C0TsNz4u.js";import"./check-eHrUZTKZ.js";import"./chevron-up-C_SlY00D.js";import"./chevron-down-l-VN-YXp.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
