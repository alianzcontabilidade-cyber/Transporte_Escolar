import{l as g,g as f}from"./reportTemplate-D58gRG5C.js";import"./index-B07ifz0H.js";import"./globe-D1hsJ-zw.js";import"./check-grx_mSjX.js";import"./chevron-up-DXkKTp1U.js";import"./chevron-down-PZcXuPHO.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
