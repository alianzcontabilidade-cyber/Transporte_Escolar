import{l as g,g as f}from"./reportTemplate-B0prp_vE.js";import"./index-CkKuvQU2.js";import"./globe-UynyHon7.js";import"./check-RRv-esXD.js";import"./chevron-up-CYJk2Fo4.js";import"./chevron-down-DEqJ7qs_.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
