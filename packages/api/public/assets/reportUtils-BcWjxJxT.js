import{l as g,g as f}from"./reportTemplate-C-JAZwzk.js";import"./index-BKnLoMsQ.js";import"./globe-Cuqx9sF6.js";import"./check-COZPRLsw.js";import"./chevron-up-BgDWMNWj.js";import"./chevron-down-D8pYIry_.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
