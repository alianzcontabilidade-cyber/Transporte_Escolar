import{l as g,g as f}from"./reportTemplate-S_UNA_VL.js";import"./index-B1J3vCTL.js";import"./globe-BHrhDnJ_.js";import"./check-BweZMGPD.js";import"./chevron-up-B2yet9id.js";import"./chevron-down-DUTX-0LJ.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
