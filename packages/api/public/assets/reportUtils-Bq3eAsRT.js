import{l as g,g as f}from"./reportTemplate-4HA8Sb6y.js";import"./index-DQuWB6-W.js";import"./globe-C8Vd2NHy.js";import"./check-C_wvwpZt.js";import"./chevron-up-B_NbkHot.js";import"./chevron-down-B9NRpPc9.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
