import{l as h,g as p}from"./reportTemplate-CLXsOz1S.js";import"./index-CmEczpHJ.js";import"./globe-D7T1alfL.js";import"./check-OcHjKcdN.js";import"./chevron-up-D7_9Jp9o.js";import"./chevron-down-11zsABwI.js";let n=null,d=null;async function $(r,e){return d===r&&n||(n=await h(r,e),d=r),n}function z(r,e,o,a,t){if(!(e!=null&&e.length))return"";const g=e.map(l=>"<tr>"+Object.values(l).map(m=>{const i=m??"--";return typeof i=="string"&&(i.startsWith("data:image")||i.startsWith("http"))?'<td style="text-align:center"><img src="'+i+'" style="width:35px;height:40px;object-fit:cover;border-radius:4px" /></td>':"<td>"+i+"</td>"}).join("")+"</tr>").join(""),c=`
    <table>
      <thead>
  ...
  `;return a?p({municipality:a.municipality,secretaria:a.secretaria,title:r.toUpperCase(),subtitle:(t==null?void 0:t.subtitle)||e.length+" registro(s)",content:c,signatories:t==null?void 0:t.signatories,orientation:(t==null?void 0:t.orientation)||(o.length>6?"landscape":"portrait"),fontSize:(t==null?void 0:t.fontSize)||11,fontFamily:"sans-serif"}):`<!DOCTYPE html><html><head><meta charset="utf-8"><title>${r}</title>
    ...
    </head><body><h1>${r}</h1>${c}<div class="footer">NetEscol - ${new Date().toLocaleDateString("pt-BR")}</div></body></html>`}export{z as buildTableReportHTML,$ as getMunicipalityReport};
