import{l as g,g as f}from"./reportTemplate-BDZHbuKl.js";import"./index-D-0f7f71.js";import"./globe-CMc7gawZ.js";import"./check-C0CTHNdc.js";import"./chevron-up-BM87-8nj.js";import"./chevron-down-Dh64ktAl.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
