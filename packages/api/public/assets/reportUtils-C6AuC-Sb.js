import{l as g,g as f}from"./reportTemplate-tBL9ewot.js";import"./index-DNhTadGL.js";import"./globe-BC08txeE.js";import"./check-ChBf6oUs.js";import"./chevron-up-DOE6uWRM.js";import"./chevron-down-C1lZVaxg.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
