import{l as g,g as f}from"./reportTemplate-kAqSLgyS.js";import"./index-FjM8541D.js";import"./globe-CjY-hXdD.js";import"./check-GNHmUpfW.js";import"./chevron-up-BcVLUkvN.js";import"./chevron-down-BScul40Y.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
