import{l as g,g as f}from"./reportTemplate-Dkvz-4bp.js";import"./index-CTp6ENgx.js";import"./globe-ByjVVs77.js";import"./check-uPuObQ2N.js";import"./chevron-up-CE4H0gmJ.js";import"./chevron-down-BnM2ttKi.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
