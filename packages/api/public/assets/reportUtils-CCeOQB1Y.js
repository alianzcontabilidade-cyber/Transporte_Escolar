import{l as g,g as f}from"./reportTemplate-Ob0jU1nS.js";import"./index-BCOVIneH.js";import"./globe-DEDmHA-Z.js";import"./check-DR7ahMD0.js";import"./chevron-up-BDBOpkGW.js";import"./chevron-down-RZeC7eJR.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
