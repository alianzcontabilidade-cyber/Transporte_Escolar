import{l as g,g as f}from"./reportTemplate-CibqRsrz.js";import"./index-DcsJnVmX.js";import"./globe-xk47AP-T.js";import"./check-DftEdPlM.js";import"./chevron-up-DLt9zQGZ.js";import"./chevron-down-BLMvCruY.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
