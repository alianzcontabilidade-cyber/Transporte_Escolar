import{l as g,g as f}from"./reportTemplate--D2XBGKD.js";import"./index-BnhoKf8c.js";import"./globe-Dd-EBzAN.js";import"./check-C9TGz7I6.js";import"./chevron-up-DZd_1Wfi.js";import"./chevron-down-Diw-gCj3.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
