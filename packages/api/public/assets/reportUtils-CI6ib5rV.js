import{l as g,g as f}from"./reportTemplate-DC3oaxAC.js";import"./index-DQkwV6pR.js";import"./globe-Bggk29Ko.js";import"./check-DwvL07eh.js";import"./chevron-up-D-GOGnya.js";import"./chevron-down-P_Sxy0yx.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
