import{l as g,g as f}from"./reportTemplate-CwRQGbfa.js";import"./index-DsKeqII9.js";import"./globe-Czd27lvQ.js";import"./check-CEo_6iFF.js";import"./chevron-up-ry9PL3pR.js";import"./chevron-down-Cw_HK1qI.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
