import{l as g,g as f}from"./reportTemplate-CQlaV-EG.js";import"./index-fTv-OeMw.js";import"./globe-GP1QGSMx.js";import"./check-D7C5Vpz8.js";import"./chevron-up-DdQsJNmV.js";import"./chevron-down-CPxr6ej3.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
