import{l as m,g as f}from"./reportTemplate-IlVVbTuz.js";import"./index-D8sC08Uu.js";import"./globe-mUcVJfVx.js";import"./chevron-up-TqWI0CLW.js";import"./chevron-down-CiVyXofb.js";let r=null,c=null;async function s(i,t){return c===i&&r||(r=await m(i,t),c=i),r}function y(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(g=>"<td>"+(g??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
  ...
  `;return n?f({municipality:n.municipality,secretaria:n.secretaria,title:i.toUpperCase(),subtitle:(e==null?void 0:e.subtitle)||t.length+" registro(s)",content:o,signatories:e==null?void 0:e.signatories,orientation:(e==null?void 0:e.orientation)||(l.length>6?"landscape":"portrait"),fontSize:(e==null?void 0:e.fontSize)||11,fontFamily:"sans-serif"}):`<!DOCTYPE html><html><head><meta charset="utf-8"><title>${i}</title>
    ...
    </head><body><h1>${i}</h1>${o}<div class="footer">NetEscol - ${new Date().toLocaleDateString("pt-BR")}</div></body></html>`}export{y as buildTableReportHTML,s as getMunicipalityReport};
