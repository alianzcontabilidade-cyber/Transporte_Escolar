import{l as g,g as f}from"./reportTemplate-BY_Eao2Q.js";import"./index-Dh78GDKg.js";import"./globe-DjUzt8il.js";import"./check-BaUstcAW.js";import"./chevron-up-D0vLsg_B.js";import"./chevron-down-Difj9eaX.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
