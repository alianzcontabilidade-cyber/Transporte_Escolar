import{l as g,g as f}from"./reportTemplate-jv6jLtcL.js";import"./index-j-mURueU.js";import"./globe-DNmjKWuR.js";import"./check-DKIHWLRe.js";import"./chevron-up-Dw2CnIQ_.js";import"./chevron-down-RJja0cuS.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
