import{l as g,g as f}from"./reportTemplate-DJr-kRrC.js";import"./index-CUKjRFun.js";import"./globe-Bd4rsVhz.js";import"./check-BSriC9jS.js";import"./chevron-up-BpIrshS4.js";import"./chevron-down-SRT4CzwR.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
