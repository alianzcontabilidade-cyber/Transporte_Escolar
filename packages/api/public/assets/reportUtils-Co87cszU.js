import{l as g,g as f}from"./reportTemplate-cZud0g74.js";import"./index-BA9ZppUU.js";import"./globe-DP5Wxj2o.js";import"./check-xPsjYsZG.js";import"./chevron-up-LT4y0RPe.js";import"./chevron-down-u_RldZBk.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
