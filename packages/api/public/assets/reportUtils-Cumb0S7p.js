import{l as g,g as f}from"./reportTemplate-C2Evu3tj.js";import"./index-CODg8rPf.js";import"./globe-Kc3IcLF-.js";import"./check-CjwklMwu.js";import"./chevron-up-BV875jpf.js";import"./chevron-down-HusbnwgO.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
