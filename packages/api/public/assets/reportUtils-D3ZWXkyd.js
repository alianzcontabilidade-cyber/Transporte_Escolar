import{l as g,g as f}from"./reportTemplate-DAAdtZgT.js";import"./index-oaZs60q4.js";import"./globe-D4avvpup.js";import"./check-D02FURxr.js";import"./chevron-up-DuLZb5A-.js";import"./chevron-down-B2lkyfEP.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
