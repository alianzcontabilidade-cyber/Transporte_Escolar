import{l as g,g as f}from"./reportTemplate-DZWNL7AU.js";import"./index-CDoMW1C0.js";import"./globe-BAxJr4l8.js";import"./check-C-fEyKSj.js";import"./chevron-up-CP0Rlh6p.js";import"./chevron-down-D_gaB_y_.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
