import{l as g,g as f}from"./reportTemplate-CPW6JhCb.js";import"./index-DcdBbePT.js";import"./globe-B_TpgIYl.js";import"./check-BJymlmxe.js";import"./chevron-up-D5VARQ_L.js";import"./chevron-down-BtWq0B4c.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
