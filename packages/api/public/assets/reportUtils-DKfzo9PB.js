import{l as g,g as f}from"./reportTemplate-CzdPnVNe.js";import"./index-B4B5IVDX.js";import"./globe-qOnblQet.js";import"./check-Gwrp0_tv.js";import"./chevron-up-KHfN-Oq9.js";import"./chevron-down-BxPR88Vx.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
