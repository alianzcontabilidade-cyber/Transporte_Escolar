import{l as h,g as p}from"./reportTemplate-Bfq55TYu.js";import"./index-DfSnuATu.js";import"./globe-D3NnnQW2.js";import"./check-Lafx8DtX.js";import"./chevron-up-CuiiEM8c.js";import"./chevron-down-jRzoS3Bj.js";let n=null,d=null;async function $(r,e){return d===r&&n||(n=await h(r,e),d=r),n}function z(r,e,o,a,t){if(!(e!=null&&e.length))return"";const g=e.map(l=>"<tr>"+Object.values(l).map(m=>{const i=m??"--";return typeof i=="string"&&(i.startsWith("data:image")||i.startsWith("http"))?'<td style="text-align:center"><img src="'+i+'" style="width:35px;height:40px;object-fit:cover;border-radius:4px" /></td>':"<td>"+i+"</td>"}).join("")+"</tr>").join(""),c=`
    <table>
      <thead>
