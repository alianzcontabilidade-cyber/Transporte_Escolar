import{l as g,g as f}from"./reportTemplate-D5eLzred.js";import"./index-CxQb6jBs.js";import"./globe-Ct9V9YiT.js";import"./check-Cpa4ALUQ.js";import"./chevron-up-DzcAm0Ur.js";import"./chevron-down-Dost0a4I.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
