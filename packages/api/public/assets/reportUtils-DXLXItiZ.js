import{l as g,g as f}from"./reportTemplate-BiHCjLR7.js";import"./index-NOTiL8sq.js";import"./globe-DqzX-g6w.js";import"./check-bRdqtLhh.js";import"./chevron-up--eKepWq0.js";import"./chevron-down-DLq8qRbQ.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
