import{l as g,g as f}from"./reportTemplate-CqRKKMHG.js";import"./index-CTFPUZDQ.js";import"./globe-C71r_rE7.js";import"./check-DPBSaLYF.js";import"./chevron-up-F6iwXAiY.js";import"./chevron-down-CL697tW4.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
