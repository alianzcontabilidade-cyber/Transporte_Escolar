import{l as g,g as f}from"./reportTemplate-CGHyuJdt.js";import"./index-Y_o42Zn-.js";import"./globe-DV9pGr4k.js";import"./check-BDtPeF0g.js";import"./chevron-up-J6Egaoq-.js";import"./chevron-down-BsuyqOx6.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
