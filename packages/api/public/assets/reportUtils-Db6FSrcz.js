import{l as g,g as f}from"./reportTemplate-jJJvplxF.js";import"./index-ijt-E3cd.js";import"./globe-DENxQi4R.js";import"./check-Cds-4rBF.js";import"./chevron-up-0ceju54f.js";import"./chevron-down-DQFQtAMM.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
