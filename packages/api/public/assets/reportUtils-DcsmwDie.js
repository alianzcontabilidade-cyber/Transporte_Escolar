import{l as g,g as f}from"./reportTemplate-DFU2ML4A.js";import"./index-DP94w8cZ.js";import"./globe-MNp4xMlm.js";import"./check-BACpo3qd.js";import"./chevron-up-DFXcCWqZ.js";import"./chevron-down-DlMkNiCZ.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
