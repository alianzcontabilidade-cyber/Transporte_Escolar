import{l as f,g as m}from"./reportTemplate-6XrAGc45.js";import"./index-C2RUp8TG.js";import"./globe-BJ8hF_ge.js";let r=null,c=null;async function b(i,t){return c===i&&r||(r=await f(i,t),c=i),r}function u(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(g=>"<td>"+(g??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
  ...
  `;return n?m({municipality:n.municipality,secretaria:n.secretaria,title:i.toUpperCase(),subtitle:(e==null?void 0:e.subtitle)||t.length+" registro(s)",content:o,signatories:e==null?void 0:e.signatories,orientation:(e==null?void 0:e.orientation)||(l.length>6?"landscape":"portrait"),fontSize:(e==null?void 0:e.fontSize)||11,fontFamily:"sans-serif"}):`<!DOCTYPE html><html><head><meta charset="utf-8"><title>${i}</title>
    ...
    </head><body><h1>${i}</h1>${o}<div class="footer">NetEscol - ${new Date().toLocaleDateString("pt-BR")}</div></body></html>`}export{u as buildTableReportHTML,b as getMunicipalityReport};
