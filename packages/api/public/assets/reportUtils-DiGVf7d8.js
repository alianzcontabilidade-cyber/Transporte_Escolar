import{l as g,g as f}from"./reportTemplate-mSt2BXKW.js";import"./index-Be9dWost.js";import"./globe-CPyaz_lD.js";import"./check-DC78T11R.js";import"./chevron-up-BEwzNVrr.js";import"./chevron-down-dSLNnphK.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
