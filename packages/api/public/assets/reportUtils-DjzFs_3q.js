import{l as g,g as f}from"./reportTemplate-DXPNoyru.js";import"./index-DRlvC4TR.js";import"./globe-Bpvnhnsg.js";import"./check-L-E5dpQY.js";import"./chevron-up-B4lDvQJs.js";import"./chevron-down-3idf1cL_.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
