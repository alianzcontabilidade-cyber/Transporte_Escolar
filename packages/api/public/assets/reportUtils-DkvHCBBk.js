import{l as g,g as f}from"./reportTemplate-B_Qa9Jbu.js";import"./index-DUgrOeaz.js";import"./globe-DtIasi5y.js";import"./check-D965YHCN.js";import"./chevron-up-Jy0GhL-e.js";import"./chevron-down-D5VVG9tu.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
