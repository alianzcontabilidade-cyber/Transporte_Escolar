import{l as g,g as f}from"./reportTemplate-D7mg8Nf9.js";import"./index-BR72oiKZ.js";import"./globe-B8CDEavx.js";import"./check-DEOp0-Nx.js";import"./chevron-up-CXr5va6l.js";import"./chevron-down-BSV7Aug9.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
