import{l as g,g as f}from"./reportTemplate-CwpTfCNu.js";import"./index-pre29SxU.js";import"./globe-CfjfnjR8.js";import"./check-CWxPMGXl.js";import"./chevron-up-CJKLBMZ4.js";import"./chevron-down-BrwGOgZe.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
