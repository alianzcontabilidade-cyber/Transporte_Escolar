import{l as g,g as f}from"./reportTemplate-C1PRqRb8.js";import"./index-BWQFGilf.js";import"./globe-DX2RQSRY.js";import"./check-Dbjb9lsr.js";import"./chevron-up-DXhIP7Lg.js";import"./chevron-down-DfceucRZ.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
