import{l as g,g as f}from"./reportTemplate-CKhtLdt1.js";import"./index-BLCyvb7R.js";import"./globe-BihWDgto.js";import"./check-BBEBa-nL.js";import"./chevron-up-CUAJcylQ.js";import"./chevron-down-BjI5_dDW.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
