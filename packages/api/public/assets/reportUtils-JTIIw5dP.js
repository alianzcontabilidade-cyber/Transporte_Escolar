import{l as g,g as f}from"./reportTemplate-CzI25iPu.js";import"./index-BtcixSS6.js";import"./globe-Cnxo6osN.js";import"./check-Bi4p7GHI.js";import"./chevron-up-CPVTyJrQ.js";import"./chevron-down-GyPxY-iq.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
