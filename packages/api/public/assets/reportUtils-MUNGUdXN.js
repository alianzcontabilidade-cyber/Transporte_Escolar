import{l as f,g as m}from"./reportTemplate-B2Ul8k9G.js";import"./index-DpigVQCU.js";import"./globe-TEd8Ib-b.js";let r=null,c=null;async function b(i,t){return c===i&&r||(r=await f(i,t),c=i),r}function u(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(g=>"<td>"+(g??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
