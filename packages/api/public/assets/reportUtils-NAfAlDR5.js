import{l as g,g as f}from"./reportTemplate-DYk7cmeY.js";import"./index-C2RI26XE.js";import"./globe-B1cTKanw.js";import"./check-CsyZvn-j.js";import"./chevron-up-peGbjpw1.js";import"./chevron-down-BpZWnp68.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
