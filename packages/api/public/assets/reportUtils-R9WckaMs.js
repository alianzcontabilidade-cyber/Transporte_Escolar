import{l as g,g as f}from"./reportTemplate-CmyoHKcm.js";import"./index-DRXxvxvx.js";import"./globe-CeU56aIC.js";import"./check-Ca4mqsJA.js";import"./chevron-up-CB9UzTgq.js";import"./chevron-down-DJJGaj3l.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
