import{l as g,g as f}from"./reportTemplate-BiS0eYkg.js";import"./index-DDwBnYhA.js";import"./globe-CMrTOGd_.js";import"./check-kt2pB_AQ.js";import"./chevron-up-MobPDi50.js";import"./chevron-down-CCr5qtQX.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
