import{l as g,g as f}from"./reportTemplate-D98dyfRx.js";import"./index-e7UefA8y.js";import"./globe-DbwGioVl.js";import"./check-Mvq0oD6r.js";import"./chevron-up-0CDaONoo.js";import"./chevron-down-B13JHB_E.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
