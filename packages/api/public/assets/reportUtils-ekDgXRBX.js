import{l as g,g as f}from"./reportTemplate--Et62m88.js";import"./index-2sdbASoE.js";import"./globe-Bb9NrTPU.js";import"./check-DLazFbYa.js";import"./chevron-up-BYpun_qP.js";import"./chevron-down-CLDbuHdt.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
