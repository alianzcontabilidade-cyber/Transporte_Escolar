import{l as g,g as f}from"./reportTemplate-BRunBTog.js";import"./index-BTgHWPQ9.js";import"./globe-BbZlZcRZ.js";import"./check-X4en9Vi2.js";import"./chevron-up-CrT0m03z.js";import"./chevron-down-DK56HikR.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
