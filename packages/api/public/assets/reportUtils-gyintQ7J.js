import{l as g,g as f}from"./reportTemplate-CGw1YG8o.js";import"./index-CO11jT6k.js";import"./globe-CKqt0aLs.js";import"./check-CuVk-tQN.js";import"./chevron-up-DF8ra8eB.js";import"./chevron-down-ivd2aodL.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
