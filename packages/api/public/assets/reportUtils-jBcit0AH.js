import{l as g,g as f}from"./reportTemplate-VTTgG4w8.js";import"./index-C2lot7ME.js";import"./globe-bMPSWQ0q.js";import"./check-CoMilhI2.js";import"./chevron-up-DIBHRF1Y.js";import"./chevron-down-q0zqAKmw.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
