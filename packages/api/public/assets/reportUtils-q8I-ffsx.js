import{l as g,g as f}from"./reportTemplate-CfqpgfoC.js";import"./index-C6Lt0akm.js";import"./globe-BY7WG1oO.js";import"./check-Crwxh61M.js";import"./chevron-up-DDqvufTO.js";import"./chevron-down-6n_Mbhrv.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
