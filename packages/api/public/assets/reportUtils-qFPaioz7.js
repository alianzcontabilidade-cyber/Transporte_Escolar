import{l as g,g as f}from"./reportTemplate-CZb6pash.js";import"./index-DVYp1_tb.js";import"./globe-Ch3oBvQG.js";import"./check-CMh8MgGj.js";import"./chevron-up-BoiuzCt4.js";import"./chevron-down-D36ulJXh.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
