import{l as g,g as f}from"./reportTemplate-BKcxS6ws.js";import"./index-CWWkp42e.js";import"./globe-I8SHPJHz.js";import"./check--R6lHrj8.js";import"./chevron-up-CsKP4kCo.js";import"./chevron-down-DV_XAWMo.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
