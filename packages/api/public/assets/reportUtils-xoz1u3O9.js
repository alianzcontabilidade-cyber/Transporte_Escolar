import{l as g,g as f}from"./reportTemplate-DCI3s_3D.js";import"./index-DrlBEVol.js";import"./globe-CxD6ZB7H.js";import"./check-CsqJm-vF.js";import"./chevron-up-1Of5noZH.js";import"./chevron-down-CLPZ0xYs.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
