import{l as g,g as f}from"./reportTemplate-BCx63ZVt.js";import"./index-BqOZm60i.js";import"./globe-DQy6cbb4.js";import"./check-DvPhd2TY.js";import"./chevron-up-BjMkJh3S.js";import"./chevron-down-BTkzDbyz.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
