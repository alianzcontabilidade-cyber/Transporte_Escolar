import{l as g,g as f}from"./reportTemplate-Waxj6T_k.js";import"./index-Dg42wWca.js";import"./globe-HewNOs_C.js";import"./check-DCo7CM6H.js";import"./chevron-up-CTMyGG3e.js";import"./chevron-down-BQAAcTSE.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
