import{l as g,g as f}from"./reportTemplate-DV_d1y0B.js";import"./index-BjKGjuEw.js";import"./globe-Bjy9SOEB.js";import"./check-CFxyFEDC.js";import"./chevron-up-A0_FefoX.js";import"./chevron-down-_PnGFZL3.js";let r=null,c=null;async function y(i,t){return c===i&&r||(r=await g(i,t),c=i),r}function $(i,t,l,n,e){if(!(t!=null&&t.length))return"";const d=t.map(a=>"<tr>"+Object.values(a).map(m=>"<td>"+(m??"--")+"</td>").join("")+"</tr>").join(""),o=`
    <table>
      <thead>
